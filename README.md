...
изолируют клиентов друг от друга, гостевые сети — всегда), либо брандмауэр. Для коллег вне вашей
сети нужен VPN (Tailscale — тогда даёте его 100.x-адрес) или туннель (`ssh -R`, cloudflared).
