...
Пока крутятся барабаны или листается лента ставок, в окно браузера идёт живое видео
(JPEG-кадры ~8 к/с), а не только скриншот на момент решения. Скорость решения: `--ticks 48`
